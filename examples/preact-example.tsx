...
function UserEditor(): JSX.Element {
  const user = useJods(userStore);

  const handleFirstNameChange = (
    e: JSX.TargetedEvent<HTMLInputElement, Event>
  ): void => {
    userStore.firstName = (e.target as HTMLInputElement).value;
  };

  const handleLastNameChange = (
    e: JSX.TargetedEvent<HTMLInputElement, Event>
  ): void => {
    userStore.lastName = (e.target as HTMLInputElement).value;
  };
